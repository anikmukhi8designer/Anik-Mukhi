        ...
        <div className="md:col-span-5 md:pl-12 pt-4 flex flex-col justify-between h-full">
          <div>
            <div className="flex items-center gap-4 mb-6">
              {/* EDITABLE: ID and Category styling */}
            ...
            {/* EDITABLE: Title and Description styling */}
            <h3 
              onClick={() => onClick(project.id)}
              className="text-4xl md:text-6xl font-bold tracking-tighter mb-6 group-hover:text-white transition-colors cursor-pointer"
            >
              {project.title}
            </h3>
            <p className="text-neutral-400 text-lg md:text-xl max-w-md leading-relaxed mb-8">
              {project.description}
            </p>
          </div>
          ...
          <div className="flex justify-between items-end border-t border-neutral-900 pt-8">
             ...
             <button 
              onClick={() => onClick(project.id)}
              className="group/btn flex items-center gap-2 overflow-hidden px-4 py-2 border border-neutral-800 rounded-full hover:bg-white hover:text-black transition-all duration-300"
             >
